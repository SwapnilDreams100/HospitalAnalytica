...
df = df[['DATE','ID','PATIENT','ENCOUNTER','MODALITY CODE','MODALITY DESCRIPTION','SOP CODE','SOP DESCRIPTION']]
...
for index,row in df.iterrows():
	...
	mycursor.execute('INSERT INTO imaging_studies(IMG_DATE,ID,PATIENT,ENCOUNTER,MODALITY_CODE,MODALITY_DESCRIPTION,SOP_CODE,SOP_DESCRIPTION) VALUES(%s,%s,%s,%s,%s,%s,%s)', new_str)
mydb.commit()
